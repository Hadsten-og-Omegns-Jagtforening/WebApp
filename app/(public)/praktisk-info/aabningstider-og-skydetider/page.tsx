const openingHours = [
  { season: 'Februar - marts', hours: 'Lørdage fra kl. 13.00 - 16.00' },
  { season: 'April - august', hours: 'Onsdage fra kl. 18.30 - 21.30' },
  { season: 'September', hours: 'Lørdage fra kl. 13.00 - 16.00' },
]
  ...
  return (
    <section className="section">
      <div className="container copy-page">
        ...
        <div className="copy-stack cards-stack cards-stack--lg">
          ...
          <section className="info-panel">
            ...
            <p>
              Herudover må vi afvikle stævner, kurser og øvelser på 4 weekender i hvert halvår:
          ...
          <section className="info-panel">
            ...
            <p>Kig forbi en træningsaften eller skriv til os på booking@hadstenjagtforening.dk.</p>
          </section>
        </div>
      </div>
    </section>
