      ...
      <div className="container" style={{ maxWidth: 980 }}>
        ...
        <div className="grid-2" style={{ alignItems: 'stretch', gap: 24 }}>
          <article style={{ background: 'var(--surface-raised)', border: '1px solid var(--border)', borderRadius: 8, padding: '28px 30px' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 24, margin: '0 0 12px' }}>Adresse</h2>
          ...
          <aside style={{ background: 'var(--bg-alt)', borderRadius: 8, padding: '28px 30px' }}>
            <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 24, margin: '0 0 12px' }}>Kontakt</h2>
            ...
            <a className="btn secondary" href="mailto:booking@hadstenjagtforening.dk">booking@hadstenjagtforening.dk</a>
          </aside>
        </div>
      </div>
    </section>
